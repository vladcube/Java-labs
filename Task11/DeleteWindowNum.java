...
public class DeleteWindowNum extends JFrame {
    ...
    public DeleteWindowNum(JList list, DefaultListModel<Employee> listModel) throws HeadlessException {
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        JPanel mainPanel = new JPanel();
        mainPanel.setLayout(new BoxLayout(mainPanel, BoxLayout.Y_AXIS));
        mainPanel.add(new JLabel("Depurtment number:"));
